# DRL-RMBSA
There are codes for training and testing the DRL agent for dynamic service provisioning in multi-band elastic optical networks. For more details, please check https://ieeexplore.ieee.org/abstract/document/11131684.
