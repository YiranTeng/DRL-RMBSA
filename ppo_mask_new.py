...
class MaskablePPO(OnPolicyAlgorithm):
    ...
    def __init__(
        ...
        training_start_timestep: int=0,
        training_end_timestep: int=10000000,
        ...
        self.training_start_timestep = training_start_timestep
        self.training_end_timestep = training_end_timestep
    ...
    def train(self) -> None:
        ...
        self.logger.record("train/value_max", th.max(values_pred.detach()))
        self.logger.record("train/value_min", th.min(values_pred.detach()))
        self.logger.record("train/value_mean", th.mean(values_pred.detach()))
        self.logger.record("train/return_min", th.min(rollout_data.returns))
        self.logger.record("train/return_max", th.max(rollout_data.returns))
        self.logger.record("train/return_mean", th.mean(rollout_data.returns))
    ...
    def learn(
        ...
        while self.num_timesteps < total_timesteps:
            ...
            if self.num_timesteps > self.training_start_timestep and self.num_timesteps < self.training_end_timestep:
                self.train()
