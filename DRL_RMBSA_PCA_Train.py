...
if __name__ == '__main__':
    ...
    log_dir = "./BP/Train/DRL_RMBSA_PCA"
    ...
    training_start_timestep = 375000
    ...
    env = make_vec_env("DRL-RMBSA-PCA-v0",
                       monitor_dir=log_dir,
                       env_kwargs=env_args,
                       n_envs=n_envs,
    ...
    callback = SaveOnBestTrainingRewardCallback(check_freq=20000, log_dir=log_dir, show_plot=False)
